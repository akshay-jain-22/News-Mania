...
export default async function HomePage() {
  const [latestNews, featuredArticle] = await Promise.all([getLatestNews(), getFeaturedArticle()])
        ...
        <main className="container mx-auto px-4 py-6 space-y-8">
          ...
          <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
            <div>
              ...
              <p className="text-gray-400">Stay informed with real-time updates</p>
            </div>
            ...
            {latestNews.length > 0 ? (
              ...
              <Card className="bg-[#1a1a1a] border-gray-800">
                <CardContent className="p-8 text-center">
                  ...
                  <p className="text-gray-400 mb-4">Unable to fetch the latest news. Please try refreshing the page.</p>
                  <RefreshButton />
                </CardContent>
              </Card>
            )}
